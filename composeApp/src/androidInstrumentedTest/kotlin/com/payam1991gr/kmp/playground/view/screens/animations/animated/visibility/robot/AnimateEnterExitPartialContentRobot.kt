...
interface AnimateEnterExitPartialContentRobot {
    fun PreviewScope.animateEnterExitPartialContentSample(): Any
    fun CodeScope.animateEnterExitPartialContentSample(): Any
}
