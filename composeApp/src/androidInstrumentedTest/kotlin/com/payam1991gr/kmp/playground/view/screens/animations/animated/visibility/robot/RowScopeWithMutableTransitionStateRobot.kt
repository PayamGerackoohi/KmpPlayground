...
interface RowScopeWithMutableTransitionStateRobot {
    fun PreviewScope.rowScopeWithMutableTransitionStateSample(): Any
    fun CodeScope.rowScopeWithMutableTransitionStateSample(): Any
}
