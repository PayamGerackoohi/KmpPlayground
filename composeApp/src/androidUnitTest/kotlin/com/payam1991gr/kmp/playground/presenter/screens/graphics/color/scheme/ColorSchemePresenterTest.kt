...
import com.payam1991gr.kmp.playground.presenter.screens.graphics.color.scheme.robot.robot
...
class ColorSchemePresenterTest{
    @Test
    fun test() = runTest {
        val navigator = FakeNavigator(ColorSchemeScreen)
        ColorSchemePresenter(navigator).robot {
